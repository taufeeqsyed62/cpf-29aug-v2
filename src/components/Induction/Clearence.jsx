...
const Clearence = () => {
    return (
        <div className="flex flex-col items-center h-screen p-4"> {/* Center the content vertically and horizontally */}
            ...
            <div className="w-full sm:w-3/4 lg:w-1/2 flex justify-between px-4"> {/* Added flex container for the bottom text */}
                <Link to="/download-pdf"><p className="text-lg cursor-pointer hover:underline">Download PDF</p></Link>
                <Link to="/share-social"><p className="text-lg cursor-pointer hover:underline">Share on Social</p></Link>
            </div>
