    ...
    return (
        <div className={`flex flex-col items-center min-h-screen p-4 ${isMobile ? "pb-20" : ""}`}> {/* Center the content vertically and horizontally */}
            <div className="mt-8 mx-auto text-center">
                <h1 className="text-3xl  font-sans font-medium text-[#605383]">Congratulations</h1>
            </div>
            <div className="text-center mt-4 mx-auto mb-5 max-w-2xl"> {/* Center the text */}
                <p className="text-base font-sans sm:text-lg lg:text-xl">You have successfully completed the induction. Welcome Aboard!!!!</p>
            </div>
