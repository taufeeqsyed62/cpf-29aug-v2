                ...
                <Link to={`/start-induction?activeTab=${activeTab === 'part1' ? 'part2' : 'part1'}`}>
                    <div className="h-36 flex bg-[#605383] text-white rounded-xl shadow-lg p-5 m-2">
                        <div className="flex-1">
                            ...
                            <p className={`text-left overflow-wrap: break-word ${isMobile ? "text-xs " : ""}`}>Complete rest of the induction at your pace</p>
                        </div>
                ...
                <Link to="/training">
                    <div className="h-36 flex bg-[#605383] text-white rounded-xl shadow-lg p-5 m-2">
                        <div className="flex-1">
                            ...
                            <p className={`text-center overflow-wrap: break-word ${isMobile ? "text-xs" : ""}`}>Get trained faster with trainer</p>
                        </div>
