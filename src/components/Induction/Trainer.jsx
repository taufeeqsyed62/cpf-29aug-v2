...
const Trainer = () => {
    ...
    const MobileView = ()=>{
        return (
            <div className="min-h-screen bg-white p-4 pb-12">
            ...
            <div className="mb-9 relative">
                ...
                <select
                    value={selectedState}
                    onChange={handleStateChange}
                    className="appearance-none w-full md:w-64 p-2 pl-10 border rounded-lg text-medium bg-slate-200 shadow-lg"
                >
                    {statesOfIndia.map((state, index) => (
                        <option key={index} value={state}>{state}</option>
                    ))}
            ...
            <div className="mb-6">
                ...
                <div className="flex flex-col space-y-4">
                    <Link to="/trainie">
                        <div className="border p-3 rounded-lg shadow-lg bg-blue-100">
                            <div className="flex justify-between items-center">
